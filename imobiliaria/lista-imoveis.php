        ...
        <div class="row">
            ...
            <?php 
                ...
                if (@$_GET['tipo-imovel'] != null) {
                        ...
                        $res = $pdo->query("SELECT * FROM imoveis where tipo = '" . $idTipo . "' order by id desc ");
                       
                    } else {
                        if ($quartos=="mais" && $garagens=="mais") {
                            $res = $pdo->query("SELECT * FROM imoveis where status LIKE '%" . $status . "%' and cidade = '" . $cidade . "' and bairro LIKE '%" . $bairro . "%' and tipo LIKE '%" . $tipo . "%' and quartos >= 6 and garagens >= 6 and condicao LIKE '%" . $condicao . "%' and area >= '" . $areaInicio . "' and area <= '" . $areaFinal . "' and valor >= '" . $valorInicio . "' and valor <= '" . $valorFinal . "' order by id desc ");
                            

                        } else if ($quartos=="mais" && $garagens!="mais") {
                             $res = $pdo->query("SELECT * FROM imoveis where status LIKE '%" . $status . "%' and cidade = '" . $cidade . "' and bairro LIKE '%" . $bairro . "%' and tipo LIKE '%" . $tipo . "%' and quartos >= 6 and garagens LIKE '%" . $garagens . "%' and condicao LIKE '%" . $condicao . "%' and area >= '" . $areaInicio . "' and area <= '" . $areaFinal . "' and valor >= '" . $valorInicio . "' and valor <= '" . $valorFinal . "' order by id desc ");
                            

                        } else if ($quartos!="mais" && $garagens=="mais") {
                             $res = $pdo->query("SELECT * FROM imoveis where status LIKE '%" . $status . "%' and cidade = '" . $cidade . "' and bairro LIKE '%" . $bairro . "%' and tipo LIKE '%" . $tipo . "%' and quartos LIKE '%" . $quartos . "%' and garagens >= 6 and condicao LIKE '%" . $condicao . "%' and area >= '" . $areaInicio . "' and area <= '" . $areaFinal . "' and valor >= '" . $valorInicio . "' and valor <= '" . $valorFinal . "' order by id desc ");

                           

                        } else {
                             $res = $pdo->query("SELECT * FROM imoveis where status LIKE '%" . $status . "%' and cidade = '" . $cidade . "' and bairro LIKE '%" . $bairro . "%' and tipo LIKE '%" . $tipo . "%' and quartos LIKE '%" . $quartos . "%' and garagens LIKE '%" . $garagens . "%' and condicao LIKE '%" . $condicao . "%' and area >= '" . $areaInicio . "' and area <= '" . $areaFinal . "' and valor >= '" . $valorInicio . "' and valor <= '" . $valorFinal . "' order by id desc ");
                ...
                <div class="property-item">
                    <a href="imovel-detalhes.php?id=<?php echo $id ?>">
                        <div class="pi-pic set-bg" data-setbg="sistema/img/imoveis/<?php echo $imagem ?>">
                            <div class="label <%=classe%>"><?php echo $status ?></div>
                        </div>
                    </a>
                    <div class="pi-text">
                        ...
                        <h5><a href="imovel-detalhes.jsp?id=<?php echo $id ?>"><?php echo $titulo ?></a></h5>
