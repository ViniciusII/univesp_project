    ...
    <div class="container">
        ...
        <div class="row property-filter">
            ...
            <!-- Início dos cards -->
             ...
             <?php 
          $res = $pdo->query("SELECT * FROM imoveis where status = 'Para Venda' or status = 'Para Aluguel' order by id desc LIMIT $limite, $itens_por_pagina ");
          $dados = $res->fetchAll(PDO::FETCH_ASSOC);
          for ($i=0; $i < count($dados); $i++) { 
            foreach ($dados[$i] as $key => $value) {
            }
          ...
          $res_p = $pdo->query("SELECT * FROM imoveis where status = 'Para Venda' or status = 'Para Aluguel'");
            ...
            <div class="col-lg-4 col-md-6 mix all house">
                <div class="property-item">
                    ...
                    <div class="pi-text">
                        ...
                        <h5><a href="imovel-detalhes.php?id=<%=id%>"><?php echo $titulo ?></a></h5>
