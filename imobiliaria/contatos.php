                ...
                <div class="cf-content">
                    <div class="cc-title">
                        ...
                        <p>Preencha os campos abaixo para entrar em contato conosco, iremos responder em breve, <br>
                            se preferir pode entrar também em contato via whatsapp <a class="text-dark" target="_blank" href="http://api.whatsapp.com/send?1=pt_BR&phone=<?php echo $whatsappLink ?>"><i class="fa fa-whatsapp mr-1"></i> <?php echo $whatsappLink ?> </a></p>
                    </div>
                ...
                <div class="contact-info">
                    ...
                    <div class="ci-item">
                        ...
                        <div class="ci-text">
                            <h5>Telefones</h5>
                            <ul>
                                <li><a class="text-dark" target="_blank" href="http://api.whatsapp.com/send?1=pt_BR&phone=<?php echo $whatsappLink ?>"><i class="fa fa-whatsapp"></i> <?php echo $whatsappLink ?> </a> </li>
                                <li><?php echo $telfixo ?></li>
                            </ul>
                        </div>
                    </div>
                    <div class="ci-item">
