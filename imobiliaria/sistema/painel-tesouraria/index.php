...
$query = $pdo->query("SELECT * FROM alugueis where ativo = 'Sim' and data_pgto <= curDate() and data_final >= curDate()");
...
if($linhas > 0){
    ...
    $query = $pdo->query("SELECT * FROM compradores where doc = '" . $doc . "' ");
    $res = $query->fetchAll(PDO::FETCH_ASSOC);
    $nomeInquilino = @$res[0]['nome'];

    $query = $pdo->query("SELECT * FROM imoveis where id = '" . $id_im . "' ");
    $res = $query->fetchAll(PDO::FETCH_ASSOC);
    $cpfVendedor = @$res[0]['vendedor'];

    $query = $pdo->query("SELECT * FROM vendedores where doc = '" . $cpfVendedor . "' ");
    $res = $query->fetchAll(PDO::FETCH_ASSOC);
    $nomeVendedor = @$res[0]['nome'];

    //ADICIONAR 30 DIAS A DATA DE PAGAMENTO
    $data_pgto = date('Y/m/d', strtotime("+30 days",strtotime($data_pgto)));

    //atualizando a data pagamento para 30 dias posterior
    $pdo->query("UPDATE alugueis set data_pgto = '" . $data_pgto . "' where id = '" . $id_al . "' ");
     
     //Lançar a cobrança na tabela contas a receber e na tabela contas Pagar
    $pdo->query("INSERT into contas_receber (valor, titulo, descricao, tipo, corretor, data, pago, cliente) values ('" . $valor . "', 'Pagamento Aluguel', '" . $nomeInquilino . "', 'Aluguel', '" . $corretor . "', curDate(), 'Não', '" . $doc . "'  )");

    $pdo->query("INSERT into contas_pagar (valor, titulo, descricao, pago, tesoureiro, data) values ('" . $valor . "', 'Aluguel', '" . $nomeVendedor . "', 'Não', '', curDate()  )");
 ...
 <?php 
    ...
    $dados = $res->fetchAll(PDO::FETCH_ASSOC);
     ...
     $img = $dados[0]['foto'];
      ...
      $res2 = $pdo->query("SELECT * FROM tesoureiros where cpf = '" . $cpfUsuario . "' ");
    $dados2 = $res2->fetchAll(PDO::FETCH_ASSOC);
     ...
     $telefone = $dados2[0]['telefone'];
      ...
      if ($nivelUsuario == null || $nivelUsuario!="tesoureiro") {
    ...
    $menu4 = "vendas";
    $menu5 = "alugueis";
    $menu6 = "imoveis-vendas";
    $menu7 = "imoveis-alugueis";
    $menu8 = "saidas";
    $menu9 = "compradores";
    $menu10 = "vendedores";
                 ...
                 <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu1 ?>">Contas Pagar</a>
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu2 ?>">Contas Receber</a>
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu3 ?>">Movimentações</a>
                        </div>
                    </div>
                </li>
                 ...
                 <li class="nav-item">
                    ...
                    <div id="collapseClientes" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu9 ?>">Compradores</a>
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu10 ?>">Vendedores</a>
                        </div>
                    </div>
                </li>
