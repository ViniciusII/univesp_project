...
if($cpf!=$antigo){
    $res = $pdo->query("SELECT * from corretores where cpf = '$cpf'");
...
if($id == ""){
    ...
    if($imagem == "sem-foto.jpg"){     
     $pdo->query("UPDATE corretores SET nome = '" . $nome . "', cpf = '" . $cpf . "', telefone = '" . $telefone . "', email = '" . $email . "', endereco = '" . $endereco . "' WHERE id = '" . $id . "' ");   
     $pdo->query("UPDATE usuarios SET nome = '" . $nome . "', cpf = '" . $cpf . "', email = '" . $email . "' WHERE cpf = '" . $antigo . "' "); 
 }else{  
  $pdo->query("UPDATE corretores SET nome = '" . $nome . "', cpf = '" . $cpf . "', telefone = '" . $telefone . "', email = '" . $email . "', endereco = '" . $endereco . "', foto = '" . $imagem . "' WHERE id = '" . $id . "' "); 
